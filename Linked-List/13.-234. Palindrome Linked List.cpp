...
public:
    ...
    */
    ...
    //below is the helper function for reversing the linked list
    //this is a simpler approach for reversing the linked list , if we see the reversing linked list question there are many approaches defined and this one is straight and sleek
