...
public:
    ...
    ***important point-> for space optimization solution we just jeed to seee what part is being used if we see  above it is just talking about previous row and hence we can convert this 3d into 3d space optimization
