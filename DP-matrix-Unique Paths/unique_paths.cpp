...
To reduce the time from 2^mn to mn used DP since maximum places we can go in the matrix are m*n and hence used DP array to deal with overlapping sub problems.
